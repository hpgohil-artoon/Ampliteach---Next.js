...
export function TrialCta({ block }: { block: TrialCtaBlock }) {
  return (
    <section id={block.anchorId} className="bg-primary p-5">
      ...
      {/* NO container inset. This live section carries `padding: 20px` on the
       * SECTION (the `p-5` above) and its container takes no Elementor inset of
       * its own — unlike most sections on this page, which are the other way
       * round. Adding both put every element here 20px in at 480. */}
